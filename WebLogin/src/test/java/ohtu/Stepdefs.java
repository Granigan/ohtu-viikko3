...
public class Stepdefs {
    ...
    public void user_with_valid_username_and_password_is_created(String un, String pwd) throws Throwable {
        driver.get(baseUrl);
        WebElement element = driver.findElement(By.linkText("register new user"));
        element.click();

        registerWith(un, pwd, pwd);
    ...
    public void user_with_invalid_username_and_invalid_password_fails_creation(String un, String pwd) throws Throwable {
        driver.get(baseUrl);
        WebElement element = driver.findElement(By.linkText("register new user"));
        element.click();
    ...
    @When("^failed to register username \"([^\"]*)\" and password \"([^\"]*)\" are given$")
    public void invalid_username_and_invalid_password_are_given(String un, String pwd) throws Throwable {
        logInWith(un, pwd);
    }
